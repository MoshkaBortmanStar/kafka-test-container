package io.tpd.kafkaexample.kafka_test;

import static org.hamcrest.CoreMatchers.containsString;
import static org.hamcrest.CoreMatchers.equalTo;
import static org.hamcrest.MatcherAssert.assertThat;

import io.tpd.kafkaexample.KafkaConsumer;
import io.tpd.kafkaexample.KafkaProducer;
...
public class KafkaTestContainersLiveTest {
    ...
    public void givenKafkaDockerContainer_whenSendingtoDefaultTemplate_thenMessageReceived() throws Exception {
        ...
        assertThat(consumer.getPayload(), containsString("Sending with"));
    }
    @SuppressWarnings("ResultOfMethodCallIgnored")
    @Test
